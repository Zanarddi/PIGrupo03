...
/**
 * Tela que permite a realiza��o das revis�es
 * Apresenta ao usu�rio diversas perguntas com respostas de m�ltipla escolha
 * 
...
public class TelaRevisao extends TelaPadrao {
	...
	/**
	 * Aciciona listeners aos bot�es da tela
	 */
	private void setListeners() {
		...
		/**
		 * Inicia uma sess�o de revis�o e distribui as perguntas na tela
		 */
		...
		/**
		 * Listener do bot�o que navega entre as perguntas
		 */
